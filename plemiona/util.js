		...
		'Script', `<div id='dudialog'><form>
            ...
            <fieldset><legend>Market Manager</legend><table>
                <tr>
                    ...
                    <td><input type="checkbox" id="market-enabled" name="marketEnabled" onchange="saveSettings()" ${SETTINGS.market.enabled == 1 || SETTINGS.market.enabled == null ? 'checked="checked"' : ''}></td>
                </tr>
            </table></fieldset>
